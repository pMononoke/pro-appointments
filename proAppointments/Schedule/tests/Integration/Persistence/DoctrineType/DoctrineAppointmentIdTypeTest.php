...
use ProAppointments\Schedule\Adapter\Out\Persistence\Doctrine\Config\Type\DoctrineAppointmentIdType;
use ProAppointments\Schedule\Domain\Appointment\AppointmentId;

class DoctrineAppointmentIdTypeTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        try {
            $this->type = Type::getType('appointment_id_test');
    ...
    {
        Type::addType('appointment_id_test', DoctrineAppointmentIdType::class);
    }

    /** @test */
    public function it_can_get_name(): void
    {
        $this->assertEquals('schedule_appointment_id', $this->type->getName());
    }
    ...
    public function it_can_convert_to_a_php_value(): void
    {
        $value = self::UUID;
        $this->assertEquals(
            AppointmentId::fromString(self::UUID),
    ...
    {
        $status = self::UUID;
        $guFeedId = AppointmentId::fromString(self::UUID);
