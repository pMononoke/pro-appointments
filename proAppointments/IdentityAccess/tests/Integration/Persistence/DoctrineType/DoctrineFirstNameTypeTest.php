...
class DoctrineFirstNameTypeTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        try {
            $this->type = Type::getType('identity_first_name_test');
    ...
    {
        Type::addType('identity_first_name_test', DoctrineFirstNameType::class);
    }

    /** @test */
    public function it_can_get_name(): void
    {
        $this->assertEquals('identity_first_name', $this->type->getName());
    }
    ...
    public function it_can_convert_to_a_database_value(): void
    {
        ...
        $lastName = FirstName::fromString(self::FIRST_NAME);
    ...
    public function it_can_not_convert_bad_value_to_php_value(): void
    {
        ...
        $this->type->convertToPHPValue($badFirstName, $this->platform);
    }
