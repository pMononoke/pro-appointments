...
use ProAppointments\IdentityAccess\Infrastructure\Persistence\Doctrine\Config\Type\DoctrineUserIdType;

class DoctrineUserIdTypeTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        try {
            $this->type = Type::getType('identity_user_id_test');
    ...
    {
        Type::addType('identity_user_id_test', DoctrineUserIdType::class);
    }

    /** @test */
    public function it_can_get_name(): void
    {
        $this->assertEquals('identity_user_id', $this->type->getName());
    }
    ...
    {
        $status = self::UUID;
        $guFeedId = UserId::fromString(self::UUID);
